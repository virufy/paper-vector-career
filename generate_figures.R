...
#   Fig 3 (§4.4) – Career ROI Pathway (LMG full-sample)
################################################################################
...
save_fig(fig2, "output/fig2_subgroup_comparison", width = 10, height = 6)

# ════════════════════════════════════════════════════════════════════════════
# FIGURE 3 – Career ROI Pathway / LMG Full Sample  (§4.4)
# ════════════════════════════════════════════════════════════════════════════

cat("  Building Figure 3: Career ROI pathway...\n")
...
fig3 <- ggplot(lmg, aes(x = variable, y = lmg_pct, fill = category)) +
  geom_col(width = 0.65) +
...
save_fig(fig3, "output/fig3_career_roi_pathway", width = 9, height = 5.5)
